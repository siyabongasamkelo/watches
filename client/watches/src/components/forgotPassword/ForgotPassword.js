  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      ...
      try {
        ...
        const recoverPassword = await postRequest(
        ...
        if (recoverPassword?.error) {
          ...
          setLoading(false);
          return showToastErrorMessage(recoverPassword?.err?.response?.data);
        }
    ...
    <LoginStyled>
      ...
      <LoginContent>
        ...
        <LoginForm onSubmit={formik.handleSubmit}>
          ...
          <RegisterNowText>
            We will send recovery link to this email...the link will expire in
            15 minutes
          </RegisterNowText>
